...
final ThemeData tenorWispTheme = ThemeData(
  ...
  textTheme: const TextTheme(
    displayLarge: TextStyle(fontFamily: 'Nunito', color: AppColors.darkSlate),
    displayMedium: TextStyle(fontFamily: 'Nunito', color: AppColors.darkSlate),
    displaySmall: TextStyle(fontFamily: 'Nunito', color: AppColors.darkSlate),
    headlineLarge: TextStyle(fontFamily: 'Nunito', color: AppColors.darkSlate),
    headlineMedium: TextStyle(fontFamily: 'Nunito', color: AppColors.darkSlate),
    headlineSmall: TextStyle(fontFamily: 'Nunito', color: AppColors.darkSlate),
    titleLarge: TextStyle(fontFamily: 'Nunito', fontWeight: FontWeight.bold, color: AppColors.darkSlate),
    titleMedium: TextStyle(fontFamily: 'Nunito', color: AppColors.darkSlate),
    titleSmall: TextStyle(fontFamily: 'Nunito', color: AppColors.darkSlate),
    bodyLarge: TextStyle(fontFamily: 'Nunito', color: AppColors.darkSlate),
    bodyMedium: TextStyle(fontFamily: 'Nunito', color: AppColors.darkSlate),
    bodySmall: TextStyle(fontFamily: 'Nunito', color: AppColors.coolGray),
    labelLarge: TextStyle(fontFamily: 'Nunito', fontWeight: FontWeight.bold, color: Colors.white),
    labelMedium: TextStyle(fontFamily: 'Nunito', color: AppColors.coolGray),
    labelSmall: TextStyle(fontFamily: 'Nunito', color: AppColors.coolGray),
  ).apply(
